...
<head>
    ...
    <title>Gestione PCTO - Eliminazione attività di stage</title>
        ...
        <ul class="nav-menu">
            ...
            <li class="nav-item">
                ...
                <ul class="dropdown-menu">
                    ...
                    <li><a href="#">Elimina attività di stage</a></li>
                </ul>
            </li>
        </ul>
    </div>
...
if(isset($_POST['cd_att']) && !empty($_POST['cd_att'])) {
    ...
    $query = "DELETE FROM attivita_di_stage WHERE cod_attivita = '$cod_selezionato'";
    $ris = $conn->query($query);
}
?>
