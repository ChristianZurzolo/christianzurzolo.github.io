...
<head>
    ...
    <title>Gestione PCTO - Visualizzazione tutor aziendali</title>
        ...
        <ul class="nav-menu">
            <li class="nav-item">
                ...
                <ul class="dropdown-menu">
                    ...
                    <li><a href="#">Tutor Aziendali</a></li>
...
if(isset($_POST['tutor_cf']) && !empty($_POST['tutor_cf'])) {
    ...
    $query = "SELECT * FROM tutor_aziendale WHERE cf_tutor_aziendale = '$cf_selezionato'";
    $ris = $conn->query($query);
