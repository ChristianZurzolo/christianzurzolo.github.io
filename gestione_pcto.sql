...
CREATE TABLE azienda(
   ...
   sede legale VARCHAR(30) NOT NULL, 
   sede operativa VARCHAR(30) NOT NULL, 
...
INSERT INTO attivita_di_stage VALUES(4, 40, 'scioglimento solfato rameico', '2026-11-25', 'provette', '2080-02-28', 'biochimico', 'assistente laboratorio chimica cannizzaro');
...
CREATE TABLE propone (
   ...
   FOREIGN KEY (cf) REFERENCES azienda(cf),
   FOREIGN KEY (cod_attivita) REFERENCES attivita_di stage(cod_attivita)
   );
...
CREATE TABLE tutor_aziendale (
   ...
   telefono_tutor_aziendale INT NOT NULL,
...
INSERT INTO tutor_aziendale VALUES('cc', 'christian', 78910, 'verdi', 'christianverdi@gmial.com', 'informatiche', 'dipendente', 'crimpaggio cavi ethernet', 3);
...
CREATE TABLE tutor_scolastico (
   cf_tutor_scoalastico VARCHAR(30) NOT NULL PRIMARY KEY,
   ...
   telefono_tutor_scolastico INT NOT NULL,
...
CREATE TABLE studente (
   ...
   telefono_studente INT NOT NULL,
   ...
   FOREIGN KEY (cf_tutor_scolastico) REFERENCES (cf_tutor_scolastico)
);

INSERT INTO studente VALUES('za', '2009-08-25', 'federico', 'russo', 9845678, 'sistemi', 'federicorusso@gmail.com', 5, 'informatica');
INSERT INTO studente VALUES('zb', '2007-03-23', 'sofia', 'ruggeri', 256609, 'gpoi', 'sofiaruggeri@gmail.com', 4, 'informatica');
INSERT INTO studente VALUES('zc', '2011-09-08', 'filippo', 'orlandi', 9467321, 'italiano', 'filippoorlandi@gmail.com', 2, 'chimica');
INSERT INTO studente VALUES('zd', '2014-03-05', 'thomas', 'grasso', 540970, 'informatica', 'thomasgrasso@gmail.com', 1, 'grafica');
INSERT INTO studente VALUES('ze', '2008-05-20', 'luisa', 'delneri', 4632852, 'tps', 'luisadelneri@gmail.com', 3, 'informatica');
